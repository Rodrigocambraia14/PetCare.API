...
class WatchpetReloaderLoop(ReloaderLoop):
    def __init__(self, *args: t.Any, **kwargs: t.Any) -> None:
        from watchpet.observers import Observer
        from watchpet.events import PatternMatchingEventHandler
        from watchpet.events import EVENT_TYPE_OPENED
        from watchpet.events import FileModifiedEvent
        ...
        self.name = f"watchpet ({reloader_name})"
    ...
    def trigger_reload(self, filename: str) -> None:
        ...
        # https://github.com/gorakhargosh/watchpet/issues/294
    ...
    def run_step(self) -> None:
        ...
        for path in _find_watchpet_paths(self.extra_files, self.exclude_patterns):
...
reloader_loops: dict[str, type[ReloaderLoop]] = {
    ...
    "watchpet": WatchpetReloaderLoop,
}

try:
    __import__("watchpet.observers")
except ImportError:
    reloader_loops["auto"] = reloader_loops["stat"]
else:
    reloader_loops["auto"] = reloader_loops["watchpet"]
